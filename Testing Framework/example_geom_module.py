...
def geom_tests(colors = True):
    ...
    test.add_func_test("Cube exists", Repository.Exists, [cube_name], expected_return=True)
    test.add_func_test("Cube PolyData exists", Repository.Exists, [cube_name_pd], expected_return=True)
